...
#### Lock
Este se usa para proteger el archivo de apuestas, tanto para escritura como para lectura. Esto implica que se debe tomar el lock antes de llamar a las funciones `store_bets` y `load_bets` (get_winners). 
