...
Teniendo en cuenta todas estas validaciones sobre los datos es que se desarrolló un protocolo que pretende maximizar el throughput, disminuyendo la cantidad de bytes utilizados por apuesta.
